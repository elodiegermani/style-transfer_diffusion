import os
import argparse
from pix2pix.pix2pix_trainer import trainer
from pix2pix.pix2pix_tester import tester
from utils.datasets import PairedImageDataset
    ...
    if config.mode == 'train':
        ...
        for subset_A in subset_list:
            for subset_B in subset_list:
                ...
                model_name = f'model-pix2pix_{subset_A}-to-{subset_B}'
        ...
        for subset_A in subset_list:
            for subset_B in subset_list:
                ...
                parameter_file = f"{config.model_save_dir}/model-pix2pix_{subset_A}-to-{subset_B}_b-{config.batch_size}_lr-{str_lr}_e-{config.n_epoch}.pt"
